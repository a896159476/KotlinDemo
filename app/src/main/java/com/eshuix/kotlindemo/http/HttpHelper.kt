package com.eshuix.kotlindemo.http

import android.os.Environment
import com.eshuix.kotlindemo.application
import okhttp3.*
...
object HttpHelper {
    ...
    fun createFilePath(fileName: String): File {
        val path = Objects.requireNonNull<File>(application.getExternalFilesDir(Environment.DIRECTORY_PICTURES)).absolutePath
